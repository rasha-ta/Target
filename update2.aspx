<%@ Page Language="C#" AutoEventWireup="true" CodeFile="update2.aspx.cs" Inherits="Default7" %>
                                                                ...
                                                                <td style="height: 105px; width: 496px;">
                                                                    <table width="300">
                                                                        <tbody>
                                                                            <tr valign="top">
                                                                                <td>
                                                                                    <span class="NormalDouble" style="font-size: 16pt; color: #3333cc;"><strong>Update Product
                                                                    ...
                                                                    <asp:Label ID="Label2" runat="server" Font-Bold="True" Font-Italic="True" Font-Size="Medium"
                                                                        ForeColor="Crimson" Height="1px" Style="z-index: 100; left: 263px; position: absolute;
                                                                        top: 380px" Text="Product Updated Successfully " Width="529px"></asp:Label>
                                                                    <br />
                                                                    <br />
                                                                    <br />
                                                                    <br />
