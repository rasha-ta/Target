...
<script runat="server">
    ...
    void Page_Load(Object sender, EventArgs e)
    {
        ...
        string modna = Request.Params["modname"];
       // int CategoryId = Int32.Parse(catid);
        string subcat=Request.Params["subcat"];
        string company = Request.Params["compname"];
            ProductsDB productCatalogue = new ProductsDB();
            int Categoryid = Int32.Parse(catid);
            int subid = Int32.Parse(subcat);
            if (subid == 0)
            {
                MyList.DataSource = productCatalogue.AdvanceSearch(modna, Categoryid);
            }
            else
            {
                MyList.DataSource = productCatalogue.moreAdvanceSearch(modna, Categoryid,subid,company);
            }
            ...
            <tr>
                ...
                <td valign="top" nowrap="nowrap" align="left" width="100%">
                    <table height="100%" cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
                        <tbody>
                            <tr valign="top">
                                <td nowrap="nowrap" style="font-size: large; color: #3333cc">
                                    <br />
                                    &nbsp; &nbsp; &nbsp; &nbsp;search result<asp:DataList id="MyList" runat="server" RepeatColumns="2">
                                        <ItemTemplate>
