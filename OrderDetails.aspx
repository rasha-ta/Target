...
<script runat="server">
    ...
    void Page_Load(Object sender, EventArgs e) {
        ...
        OrderDetails myOrderDetails = orderHistory.GetOrderDetails(OrderID, CustomerId);
    ...
    <table cellspacing="0" cellpadding="0" width="100%" border="0">
        <tbody>
            ...
            <tr>
                ...
                <td valign="top" nowrap="nowrap" align="left" width="100%" style="height: 352px">
                                            ...
                                            <tr valign="top">
                                                <td class="Normal" width="100%">
                                                    ...
                                                    <asp:DataGrid id="GridControl1" runat="server" AutoGenerateColumns="False" AlternatingItemStyle-CssClass="CartListItemAlt" ItemStyle-CssClass="CartListItem" FooterStyle-CssClass="cartlistfooter" HeaderStyle-CssClass="CartListHead" ShowFooter="True" Font-Size="8pt" Font-Name="Verdana" cellpadding="4" GridLines="None" width="90%" Font-Names="Verdana" ForeColor="#333333">
                                                        ...
                                                        <AlternatingItemStyle BackColor="White" CssClass="CartListItemAlt" />
