                                                                ...
                                                                <td style="height: 105px; width: 496px;">
                                                                    <table width="300">
                                                                        <tbody>
                                                                            <tr valign="top">
                                                                                <td>
                                                                                    <span class="NormalDouble" style="font-size: 16pt"><strong style="color: #3333cc">Add Product successfully
                                                                                    </strong></span></td>
                                                                            </tr>
                                                                        </tbody>
                                                                    </table>
                                                                    ...
                                                                    <br />
                                                                    <br />
                                                                    <asp:Label ID="Label1" runat="server" Height="1px" Text="Product Added Successfully "
                                                                        Width="507px" Font-Bold="True" Font-Italic="True" Font-Size="Medium" ForeColor="Crimson"></asp:Label><br />
                                                                    <br />
                                                                    <br />
                                                                    <br />
                                                                    <br />
